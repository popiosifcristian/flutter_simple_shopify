...
class ShopifyConfig {
  ...
  static void setConfig(
    ...
    _adminGraphQLClient = GraphQLClient(
      link: HttpLink(
        'https://$_storeUrl/admin/api/$_storefrontApiVersion/graphql.json',
        defaultHeaders: {
