...
class _$ShopImpl implements _Shop {
  ...
  @override
  String toString() {
    return 'Shop(description: $description, moneyFormat: $moneyFormat, name: $name, customerAccounts: $customerAccounts, paymentSettings: $paymentSettings, primaryDomain: $primaryDomain, privacyPolicy: $privacyPolicy, refundPolicy: $refundPolicy, shipsToCountries: $shipsToCountries, termsOfService: $termsOfService)';
  }
